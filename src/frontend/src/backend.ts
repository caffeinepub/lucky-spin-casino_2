...
export class Backend implements backendInterface {
    ...
    async getRecentWins(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
    ...
    async getTopPlayers(): Promise<Array<Profile>> {
        if (this.processError) {
            try {
    ...
    async submitGameResult(arg0: string, arg1: boolean, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitGameResult(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
